...
class Systeme(val mediator : Mediator) {
   ...
   */
  def addBatiment(batiment: Batiment): Unit = {
    _batiments += batiment
  }
   ...
   */
  def popBatiment(batiment: Batiment) : Unit = {
    _batiments -= batiment
  }
   ...
   */
  def addDemandeur(demandeur: Demandeur): Unit = {
   ...
   */
  def popDemandeur(demandeur: Demandeur) : Unit = {
    _demandeurs -= demandeur
  }
